#ifndef IL2CPP_INTERNAL_CLASS
#define IL2CPP_INTERNAL_CLASS
...
#if defined(__GNUC__) || defined(__clang__) || (_MSC_VER >= 1300)
...
typedef struct Il2CppDefaults
{
    ...
    struct MethodInfo *threadpool_perform_wait_callback_method;
...
{
    int count;
    struct Il2CppObject **attributes;
...
typedef void (*InvokerMethod)(Il2CppMethodPointer a0, const struct MethodInfo *a1, void *a2, void **a3, void *a4);
...
typedef struct Il2CppClass
{
    ...
    unsigned int initialized_and_no_error : 1;
    unsigned int initialized : 1;
    unsigned int enumtype : 1;
    unsigned int nullabletype : 1;
    unsigned int is_generic : 1;
    unsigned int has_references : 1;
    unsigned int init_pending : 1;
    unsigned int size_init_pending : 1;

    unsigned int size_inited : 1;
    unsigned int has_finalize : 1;
    unsigned int has_cctor : 1;
    unsigned int is_blittable : 1;
    unsigned int is_import_or_windows_runtime : 1;
    unsigned int is_vtable_initialized : 1;
    unsigned int is_byref_like : 1;
...
typedef struct Il2CppDomain
{
    ...
    struct Il2CppObject *ephemeron_tombstone;
