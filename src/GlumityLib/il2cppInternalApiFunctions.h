...
// forward declarations of required core IL2CPP types, used by the API signatures
typedef struct Il2CppClass TypeInfo; // In older/internal IL2CPP versions, TypeInfo aliases Il2CppClass
...
// Dynamic sizing type handles
#if defined(_WIN64) || defined(__amd64__) || defined(__x86_64__) || defined(__aarch64__)
typedef uint64_t il2cpp_array_size_t;
#else
typedef uint32_t il2cpp_array_size_t;
#endif

typedef Il2CppProfileFlags Il2CppProfileFlags;
typedef void (*methodPointerType)(void);
typedef void (*Il2CppProfileFunc)(Il2CppProfiler *);
typedef void (*Il2CppFrameWalkFunc)(const struct Il2CppStackFrameInfo *, void *);

#if IL2CPP_DEBUGGER_ENABLED
typedef struct Il2CppDebugTypeInfo Il2CppDebugTypeInfo;
typedef struct Il2CppDebugDocument Il2CppDebugDocument;
typedef struct Il2CppDebugMethodInfo Il2CppDebugMethodInfo;
typedef struct Il2CppDebugLocalsInfo Il2CppDebugLocalsInfo;
#endif
